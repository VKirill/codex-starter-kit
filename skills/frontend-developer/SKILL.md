...
description: Build production React and Next.js applications. Components, hooks, SSR/SSG, routing, state management, Tailwind CSS, performance optimization, accessibility.
stacks:
  - react
  - nextjs
  - frontend-react
